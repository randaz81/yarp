...
std::string ParamsFilesGenerator::generateMdParams()
{
    ...
    fill_siz[0] = strlen("Group name");
    fill_siz[1] = strlen("Parameter name");
    fill_siz[2] = strlen("Type");
    fill_siz[3] = strlen("Units");
    fill_siz[4] = strlen("Default Value");
    fill_siz[5] = strlen("Required");
    fill_siz[6] = strlen("Description");
    fill_siz[7] = strlen("Notes");
    ...
    for (const auto& param : m_params) {
        ...
        fill_siz[5] = std::max(fill_siz[5], strlen ( "true"));
