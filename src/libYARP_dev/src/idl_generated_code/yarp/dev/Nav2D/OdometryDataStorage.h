...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASTORAGE_H
#define YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASTORAGE_H
...
class YARP_dev_API OdometryDataStorage
{
public:
    // Fields
    /**
    ...
    // Default constructor
    OdometryDataStorage() = default;

    // Constructor with field values
    OdometryDataStorage(const double odom_x,
                        const double odom_y,
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASTORAGE_H
