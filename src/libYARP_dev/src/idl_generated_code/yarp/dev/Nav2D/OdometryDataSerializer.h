...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASERIALIZER_H
#define YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASERIALIZER_H
...
class YARP_dev_API OdometryDataSerializer :
        public yarp::os::WireSerializer<OdometryDataStorage>{
public:
using WireSerializer::WireSerializer;
    ...
    typedef yarp::os::idl::Unwrapped<OdometryDataSerializer> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATASERIALIZER_H
