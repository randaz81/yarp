...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_MAP2DAREADATASERIALIZER_H
#define YARP_THRIFT_GENERATOR_STRUCT_MAP2DAREADATASERIALIZER_H
...
class YARP_dev_API Map2DAreaDataSerializer :
        public yarp::os::WireSerializer<Map2DAreaDataStorage>{
public:
using WireSerializer::WireSerializer;
    ...
    typedef yarp::os::idl::Unwrapped<Map2DAreaDataSerializer> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_MAP2DAREADATASERIALIZER_H
