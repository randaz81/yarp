...
bool OdometryData6D::read(yarp::os::ConnectionReader& connection)
{
    ...
    if (!nested_read_odom_z(reader)) {
        return false;
    }
    if (!nested_read_odom_roll(reader)) {
        return false;
    }
    if (!nested_read_odom_pitch(reader)) {
        return false;
    }
    if (!nested_read_odom_yaw(reader)) {
        return false;
    }
    ...
    if (!nested_read_base_vel_z(reader)) {
        return false;
    }
    if (!nested_read_base_vel_roll(reader)) {
        return false;
    }
    if (!nested_read_base_vel_pitch(reader)) {
        return false;
    }
    if (!nested_read_base_vel_yaw(reader)) {
        return false;
    }
    ...
    if (!nested_read_odom_vel_z(reader)) {
        return false;
    }
    if (!nested_read_odom_vel_roll(reader)) {
        return false;
    }
    if (!nested_read_odom_vel_pitch(reader)) {
        return false;
    }
    if (!nested_read_odom_vel_yaw(reader)) {
        return false;
    }
    return !reader.isError();
}
...
bool OdometryData6D::write(yarp::os::ConnectionWriter& connection) const
{
    ...
    if (!nested_write_odom_z(writer)) {
        return false;
    }
    if (!nested_write_odom_roll(writer)) {
        return false;
    }
    if (!nested_write_odom_pitch(writer)) {
        return false;
    }
    if (!nested_write_odom_yaw(writer)) {
        return false;
    }
    ...
    if (!nested_write_base_vel_z(writer)) {
        return false;
    }
    if (!nested_write_base_vel_roll(writer)) {
        return false;
    }
    if (!nested_write_base_vel_pitch(writer)) {
        return false;
    }
    if (!nested_write_base_vel_yaw(writer)) {
        return false;
    }
    ...
    if (!nested_write_odom_vel_z(writer)) {
        return false;
    }
    if (!nested_write_odom_vel_roll(writer)) {
        return false;
    }
    if (!nested_write_odom_vel_pitch(writer)) {
        return false;
    }
    if (!nested_write_odom_vel_yaw(writer)) {
        return false;
    }
    return !writer.isError();
}
