...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATA6DSERIALIZER_H
#define YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATA6DSERIALIZER_H
...
class YARP_dev_API OdometryData6DSerializer :
        public yarp::os::WireSerializer<OdometryData6DStorage>{
public:
using WireSerializer::WireSerializer;
    ...
    typedef yarp::os::idl::Unwrapped<OdometryData6DSerializer> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_ODOMETRYDATA6DSERIALIZER_H
