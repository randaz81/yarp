...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_AUDIORECORDERSTATUSSERIALIZER_H
#define YARP_THRIFT_GENERATOR_STRUCT_AUDIORECORDERSTATUSSERIALIZER_H
 ...
 */
class YARP_dev_API AudioRecorderStatusSerializer :
        public yarp::os::WireSerializer<AudioRecorderStatusStorage>{
public:
using WireSerializer::WireSerializer;
    ...
    typedef yarp::os::idl::Unwrapped<AudioRecorderStatusSerializer> unwrapped;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_AUDIORECORDERSTATUSSERIALIZER_H
