...
public:
    ...
    */
    virtual yarp::dev::yarp_ret_value getControlMode(int j, int *mode)=0;
    ...
    * @return: true/false success failure.
    */
    virtual yarp::dev::yarp_ret_value getControlModes(int *modes)=0;
    ...
    * @return true/false success failure.
    */
    virtual yarp::dev::yarp_ret_value getControlModes(const int n_joint, const int *joints, int *modes)=0;
    ...
    *         (e.g. the joint is on a fault condition or the desired mode is not implemented).    */
    virtual yarp::dev::yarp_ret_value setControlMode(const int j, const int mode)=0;
    ...
    *         (e.g. the joint is on a fault condition or the desired mode is not implemented).
    */
    virtual yarp::dev::yarp_ret_value setControlModes(const int n_joint, const int *joints, int *modes)=0;
    ...
    *         (e.g. the joint is on a fault condition or the desired mode is not implemented).
    */
    virtual yarp::dev::yarp_ret_value setControlModes(int *modes)=0;
};
...
public:
    ...
    virtual yarp::dev::yarp_ret_value getControlModeRaw(int j, int *mode)=0;
    virtual yarp::dev::yarp_ret_value getControlModesRaw(int* modes)=0;
    virtual yarp::dev::yarp_ret_value getControlModesRaw(const int n_joint, const int *joints, int *modes)=0;
    virtual yarp::dev::yarp_ret_value setControlModeRaw(const int j, const int mode)=0;
    virtual yarp::dev::yarp_ret_value setControlModesRaw(const int n_joint, const int *joints, int *modes)=0;
    virtual yarp::dev::yarp_ret_value setControlModesRaw(int *modes)=0;
};
