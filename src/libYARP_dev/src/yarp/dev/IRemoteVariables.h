...
public:
    ...
    virtual yarp::dev::yarp_ret_value getRemoteVariableRaw(std::string key, yarp::os::Bottle& val) = 0;

    virtual yarp::dev::yarp_ret_value setRemoteVariableRaw(std::string key, const yarp::os::Bottle& val) = 0;

    virtual yarp::dev::yarp_ret_value getRemoteVariablesListRaw(yarp::os::Bottle* listOfKeys) = 0;
};
...
public:
    ...
    virtual yarp::dev::yarp_ret_value getRemoteVariable(std::string key, yarp::os::Bottle& val) = 0;

    virtual yarp::dev::yarp_ret_value setRemoteVariable(std::string key, const yarp::os::Bottle& val) = 0;

    virtual yarp::dev::yarp_ret_value getRemoteVariablesList(yarp::os::Bottle* listOfKeys) = 0;
};
