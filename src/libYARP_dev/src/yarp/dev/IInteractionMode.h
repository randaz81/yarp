...
public:
     ...
     */
    virtual yarp::dev::yarp_ret_value getInteractionMode(int axis, yarp::dev::InteractionModeEnum* mode)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value getInteractionModes(int n_joints, int *joints, yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value getInteractionModes(yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value setInteractionMode(int axis, yarp::dev::InteractionModeEnum mode)=0;
     ...
     */
    virtual yarp::dev::yarp_ret_value setInteractionModes(int n_joints, int *joints, yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure. If one or more joint fails, the return value will be false.
     */
    virtual yarp::dev::yarp_ret_value setInteractionModes(yarp::dev::InteractionModeEnum* modes)=0;
};
...
public:
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value getInteractionModeRaw(int axis, yarp::dev::InteractionModeEnum* mode)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value getInteractionModesRaw(int n_joints, int *joints, yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value getInteractionModesRaw(yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure.
     */
    virtual yarp::dev::yarp_ret_value setInteractionModeRaw(int axis, yarp::dev::InteractionModeEnum mode)=0;
     ...
     * @return true or false on success or failure. If one or more joint fails, the return value will be false.
     */
    virtual yarp::dev::yarp_ret_value setInteractionModesRaw(int n_joints, int *joints, yarp::dev::InteractionModeEnum* modes)=0;
     ...
     * @return true or false on success or failure. If one or more joint fails, the return value will be false.
     */
    virtual yarp::dev::yarp_ret_value setInteractionModesRaw(yarp::dev::InteractionModeEnum* modes)=0;
};
