...
public:
    virtual ~IJointFault(){}
    virtual yarp::dev::yarp_ret_value getLastJointFault(int j, int& fault, std::string& message)=0;
};
...
public:
    ...
    virtual yarp::dev::yarp_ret_value getLastJointFaultRaw(int j, int& mode, std::string& message)=0;
};
