...
yarp_ret_value ImplementControlLimits::setLimits(int axis, double min, double max)
{
    double minEnc=0;
    double maxEnc=0;
...
yarp_ret_value ImplementControlLimits::getLimits(int axis, double *min, double *max)
{
    double minEnc=0;
    double maxEnc=0;

    int k=castToMapper(helper)->toHw(axis);
    yarp_ret_value ret=iLimits2->getLimitsRaw(k, &minEnc, &maxEnc);
...
yarp_ret_value ImplementControlLimits::setVelLimits(int axis, double min, double max)
{
    double minEnc=0;
    double maxEnc=0;
...
yarp_ret_value ImplementControlLimits::getVelLimits(int axis, double *min, double *max)
{
    double minEnc=0;
    double maxEnc=0;

    int k=castToMapper(helper)->toHw(axis);
    yarp_ret_value ret=iLimits2->getVelLimitsRaw(k, &minEnc, &maxEnc);
