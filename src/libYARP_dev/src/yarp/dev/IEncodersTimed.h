...
public:
     ...
     */
    virtual yarp::dev::yarp_ret_value getEncodersTimedRaw(double *encs, double *stamps)=0;
     ...
     */
    virtual yarp::dev::yarp_ret_value getEncoderTimedRaw(int j, double *encs, double *stamp)=0;
};
...
public:
     ...
     * \return true if all goes well, false if anything bad happens.
     */
    virtual yarp::dev::yarp_ret_value getEncodersTimed(double *encs, double *time)=0;
    ...
    * \return true if all goes well, false if anything bad happens.
    */
    virtual yarp::dev::yarp_ret_value getEncoderTimed(int j, double *encs, double *time)=0;
};
