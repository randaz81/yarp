...
public:
     ...
     */
    virtual yarp::dev::yarp_ret_value getNumberOfMotors(int *ax) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrent(int m, double *curr) = 0;

    /** Get the instantaneous current measurement for all motors
    * @param currs pointer to the array that will store the output. Values are expressed in amperes.
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrents(double *currs) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentRange(int m, double *min, double *max) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentRanges(double *min, double *max) = 0;

    /** Set the reference value of the currents for all motors.
    * @param currs the array containing the reference current values. Values are expressed in amperes.
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value setRefCurrents(const double *currs) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value setRefCurrent(int m, double curr) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value setRefCurrents(const int n_motor, const int *motors, const double *currs) = 0;

   /** Get the reference value of the currents for all motors.
     * @param currs pointer to the array to be filled with reference current values. Values are expressed in amperes.
     * @return true/false on success/failure
     */
    virtual yarp::dev::yarp_ret_value getRefCurrents(double *currs) = 0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getRefCurrent(int m, double *curr) = 0;
};
...
public:
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentRaw(int m, double *curr)=0;

    /** Get the instantaneous current measurement for all motors.
    * @param currs pointer to the array that will store the output
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentsRaw(double *currs)=0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentRangeRaw(int m, double *min, double *max)=0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getCurrentRangesRaw(double *min, double *max)=0;

    /** Set the reference value of the currents for all motors.
    * @param currs the array containt the reference current values
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value setRefCurrentsRaw(const double *currs)=0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value setRefCurrentRaw(int m, double curr)=0;
     ...
     * @return true/false on success/failure
     */
    virtual yarp::dev::yarp_ret_value setRefCurrentsRaw(const int n_motor, const int *motors, const double *currs) = 0;

    /** Get the reference value of the currents for all motors.
    * @param currs pointer to the array to be filled with reference current values.
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getRefCurrentsRaw(double *currs)=0;
    ...
    * @return true/false on success/failure
    */
    virtual yarp::dev::yarp_ret_value getRefCurrentRaw(int m, double *curr)=0;
};
