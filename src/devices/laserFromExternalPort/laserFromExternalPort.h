...
class InputPortProcessor :
    public yarp::os::BufferedPort<yarp::dev::LaserScan2DSerializer>
{
    std::mutex             m_port_mutex;
    yarp::dev::LaserScan2DStorage m_lastScan;
    yarp::os::Stamp        m_lastStamp;
    bool                   m_contains_data;

public:
    InputPortProcessor(const InputPortProcessor& alt) :
            yarp::os::BufferedPort<yarp::dev::LaserScan2DSerializer>(),
    ...
    InputPortProcessor();
    using yarp::os::BufferedPort<yarp::dev::LaserScan2DSerializer>::onRead;
    void onRead(yarp::dev::LaserScan2DSerializer& v) override;
    void getLast(yarp::dev::LaserScan2DStorage& data, yarp::os::Stamp& stmp);
};
...
protected:
    ...
    std::vector <yarp::dev::LaserScan2DStorage> m_last_scan_data;
    ...
    void calculate(yarp::dev::LaserScan2DStorage scan, yarp::sig::Matrix m);
