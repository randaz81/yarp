...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDPOSESRPC_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDPOSESRPC_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/Map2DLocation.h>

class return_getEstimatedPosesRPC :
...
public:
    ...
    // Default constructor
    return_getEstimatedPosesRPC();

    // Constructor with field values
    return_getEstimatedPosesRPC(const bool ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getEstimatedPosesRPC> unwrapped;
    ...
    public:
        ...
        Editor(return_getEstimatedPosesRPC& obj);
        ...
        // Editor: edit
        bool edit(return_getEstimatedPosesRPC& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_getEstimatedPosesRPC& state();
    ...
    private:
        // Editor: state
        return_getEstimatedPosesRPC* obj;
        bool obj_owned;
        int group;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDPOSESRPC_H
