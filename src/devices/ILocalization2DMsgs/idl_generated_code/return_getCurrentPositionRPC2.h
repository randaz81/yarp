...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC2_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC2_H
...
class return_getCurrentPositionRPC2 :
...
public:
    ...
    // Default constructor
    return_getCurrentPositionRPC2();

    // Constructor with field values
    return_getCurrentPositionRPC2(const bool ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getCurrentPositionRPC2> unwrapped;
    ...
    public:
        ...
        Editor(return_getCurrentPositionRPC2& obj);
        ...
        // Editor: edit
        bool edit(return_getCurrentPositionRPC2& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_getCurrentPositionRPC2& state();
    ...
    private:
        // Editor: state
        return_getCurrentPositionRPC2* obj;
        bool obj_owned;
        int group;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC2_H
