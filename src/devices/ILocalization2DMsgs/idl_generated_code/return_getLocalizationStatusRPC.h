...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETLOCALIZATIONSTATUSRPC_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETLOCALIZATIONSTATUSRPC_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp_dev_Nav2D_LocalizationStatusEnum.h>

class return_getLocalizationStatusRPC :
...
public:
    ...
    // Default constructor
    return_getLocalizationStatusRPC();

    // Constructor with field values
    return_getLocalizationStatusRPC(const bool ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getLocalizationStatusRPC> unwrapped;
    ...
    public:
        ...
        Editor(return_getLocalizationStatusRPC& obj);
        ...
        // Editor: edit
        bool edit(return_getLocalizationStatusRPC& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_getLocalizationStatusRPC& state();
    ...
    private:
        // Editor: state
        return_getLocalizationStatusRPC* obj;
        bool obj_owned;
        int group;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETLOCALIZATIONSTATUSRPC_H
