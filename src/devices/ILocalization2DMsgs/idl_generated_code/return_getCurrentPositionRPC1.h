...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC1_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC1_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/Map2DLocation.h>

class return_getCurrentPositionRPC1 :
...
public:
    ...
    // Default constructor
    return_getCurrentPositionRPC1();

    // Constructor with field values
    return_getCurrentPositionRPC1(const bool ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getCurrentPositionRPC1> unwrapped;
    ...
    public:
        ...
        Editor(return_getCurrentPositionRPC1& obj);
        ...
        // Editor: edit
        bool edit(return_getCurrentPositionRPC1& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_getCurrentPositionRPC1& state();
    ...
    private:
        // Editor: state
        return_getCurrentPositionRPC1* obj;
        bool obj_owned;
        int group;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETCURRENTPOSITIONRPC1_H
