...
#ifndef YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDODOMETRYRPC_H
#define YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDODOMETRYRPC_H

#include <yarp/os/Wire.h>
#include <yarp/os/idl/WireTypes.h>
#include <yarp/dev/OdometryData.h>

class return_getEstimatedOdometryRPC :
...
public:
    ...
    // Default constructor
    return_getEstimatedOdometryRPC();

    // Constructor with field values
    return_getEstimatedOdometryRPC(const bool ret,
    ...
    typedef yarp::os::idl::Unwrapped<return_getEstimatedOdometryRPC> unwrapped;
    ...
    public:
        ...
        Editor(return_getEstimatedOdometryRPC& obj);
        ...
        // Editor: edit
        bool edit(return_getEstimatedOdometryRPC& obj, bool dirty = true);

        // Editor: validity check
        bool isValid() const;

        // Editor: state
        return_getEstimatedOdometryRPC& state();
    ...
    private:
        // Editor: state
        return_getEstimatedOdometryRPC* obj;
        bool obj_owned;
        int group;
...
#endif // YARP_THRIFT_GENERATOR_STRUCT_RETURN_GETESTIMATEDODOMETRYRPC_H
