...
class INavigation2DRPCd : public INavigation2DMsgs
{
    ...
    return_get_navigation_statusStorage       get_navigation_status_RPC() override;
    return_get_current_nav_waypointStorage    get_current_nav_waypoint_RPC() override;
    return_get_all_nav_waypointsStorage       get_all_navigation_waypoints_RPC(yarp::dev::Nav2D::TrajectoryTypeEnum trajectory_type) override;
    return_get_current_nav_mapStorage         get_current_navigation_map_RPC(yarp::dev::Nav2D::NavigationMapTypeEnum map_type) override;
    ...
    return_get_abs_loc_of_curr_targetStorage  get_absolute_location_of_current_target_RPC() override;
    return_get_rel_loc_of_curr_targetStorage  get_relative_location_of_current_target_RPC() override;
    ...
    return_get_last_velocity_commandStorage   get_last_velocity_command_RPC() override;

    //extra
    return_get_name_of_current_targetStorage  get_name_of_current_target_RPC() override;
};
